    ...
    return (
        <div className="new-comment">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input type="text" id="username" name="username" value={newComment.username} onChange={handleChange} placeholder='your username' required/>
                <label htmlFor="body">Comment:</label>
                <textarea id="body" name="body" value={newComment.body} onChange={handleChange} required />
                <button type="submit">
